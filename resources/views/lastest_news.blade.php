      ...
      <div class="container" data-aos="fade-up">
          <div class="col-lg-4">
            ...
            <div class="" style="height:150px; width:200px;">
              <a href="single-post.html"><img src="{{ url('storage/app/' . $items->file)}}" alt="" class="img-fluid"></a>
              </div>
              <h2>{{$items->title}}</h2>
              <p class="mb-4 d-block">{{$items->long_description}}</p>
                  <h3 class="m-0 p-0">{{$items->Author}}</h3>
                </div>
              </div>
            </div>
          </div>
